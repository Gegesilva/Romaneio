...
<body>
  <header>
      <a href="http://localhost:8090/phpprod/apnet/romaneio/impres.php"><img src='media/logoAPNET.png' width='115' height='34' style='margin-left: 15px;'  class='d-inline-block align-top'></a>
          <!-- http://localhost:8090/phpprod/apnet/romaneio/ 
               http://localhost:8090/phpprod/apnet/romaneio/-->
      <p>Apnetworks</p>
   ...
   <?php
    ...
    while ($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)){
      if($row['Seriado'] == 'N'){
        ...
        $tabela2 .= "<td width='30'>".$row['CodProduto']."</td>";
        $tabela2 .= "<td width='40%'>".$row['NomeProduto']."</td><p>";
        $tabela2 .= "<td width='40'>".$row['Patrimonio']."</td>";
        $tabela2 .= "<td width='40'>".$row['Serie']."</td>";
        $tabela2 .= "<td width='40'>".$row['Contrato']."</td>";
        $tabela2 .= "<td width='40'>".$row['Qt']."</td>";
        $tabela2 .= "</tr>";
      }  
    ...
    <div class="data-hora">
      ...
      <b class="hora">HORA:</b>
        ...
        <div class="dizeres-finais">
          ...
          <footer> 
            <div class="rodape">
            <p><a href="http://localhost:8090/phpprod/apnet/romaneio/impres.php"><img src='media/logoAPNET.png' width='115' height='34' style='margin-left: 15px;'  class='d-inline-block align-top'></a><p>
                  <!-- http://localhost:8090/phpprod/apnet/romaneio/ 
                      http://localhost:8090/phpprod/apnet/romaneio/-->
              <p>Apnetworks</p>
              <p>www.apnetworks.com.br</p>
